...
REP = [
 ...
 ('<th>Scène</th>', '<th>Scene</th>'),
 ('Produit seul — studio', 'Product only — studio'),
 ('Produit en environnement', 'Product in an environment'),
 ('Produit + 1 personnage', 'Product + 1 character'),
 ('Produit + 2 personnages', 'Product + 2 characters'),
 ...
 ('Visite animée du bien — à partir de vos photos : mouvements de caméra, transitions, montage sur musique',
  'Animated property tour — from your photos: camera moves, transitions, edited to music'),
 ('Personnage ajouté — mise en vie du lieu', 'Character added — bringing the place to life'),
